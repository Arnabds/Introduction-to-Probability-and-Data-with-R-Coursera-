...
</div> The more the bandwidth is the histogram is going to be flatter and loose curvature.
...
<li> Delta and United Airlines </li>(correct)
...
<li> Median would be more reliable as the distribution of delays is skewed. </li> (correct)
...
<li> There is an overall postive association between distance and average speed.</li> (Correct)
...
plot(df8$distance, df8$avg_speed )
